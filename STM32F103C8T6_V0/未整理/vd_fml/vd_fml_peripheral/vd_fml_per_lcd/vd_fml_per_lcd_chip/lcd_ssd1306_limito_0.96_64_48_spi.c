 ...
 * File: lcd_ssd1306_limito_0.96_64_48_spi.c
...
#if (LCD_SSD1306_LIMITO_0096_64_48_SPI == ON)
 ...
 * globals
 */
LCD_DEFINE(LCD_SSD1306_LIMITO_0096_64_48_SPI);

/**
 * @brief : lcd初始化参数表
 *
 */
LCD_INIT_PARAM(LCD_SSD1306_LIMITO_0096_64_48_SPI) = {
 ...
 *
 */
LCD_SLEEP_PARAM(LCD_SSD1306_LIMITO_0096_64_48_SPI) = {
 ...
 *
 */
LCD_WAKEUP_PARAM(LCD_SSD1306_LIMITO_0096_64_48_SPI) = {{-1, -1, -1}};

/**
 * @brief : lcd清屏参数表
 *
 */
LCD_CLEAN_PARAM(LCD_SSD1306_LIMITO_0096_64_48_SPI) = {{-1, -1, -1}};
 ...
 * @return vd_bool_t 返回处理结果
 */
vd_bool_t lcd_ssd1306_limito_64_48_spi_set_pos(vd_uint16_t xs, vd_uint16_t ys, vd_uint16_t xe, vd_uint16_t ye) {
 ...
 */
LCD_IMPLETEMTE(
    LCD_SSD1306_LIMITO_0096_64_48_SPI,
    vd_null,
    vd_null,
    vd_null,
